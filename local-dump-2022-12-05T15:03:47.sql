...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: NoahDB
--
...
ALTER TABLE public.employees OWNER TO "NoahDB";

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: NoahDB
--
